...
namespace Totallydays.Migrations
{
    ...
    [Migration("20200914122634_fix_hosting")]
    partial class fix_hosting
    {
            ...
            modelBuilder.Entity("Totallydays.Models.Hosting", b =>
                {
                    ...
                    b.Property<int>("Hosting_typeHosting_type_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Hosting_typeHosting_type_id");
            ...
            modelBuilder.Entity("Totallydays.Models.Hosting", b =>
                {
                    b.HasOne("Totallydays.Models.Hosting_type", "Hosting_type")
                        .WithMany("Hostings")
                        .HasForeignKey("Hosting_typeHosting_type_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
