...
{
    public partial class initilisation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Booking_id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HostingHosting_id = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Hostings_HostingHosting_id",
                        column: x => x.HostingHosting_id,
                        principalTable: "Hostings",
                        principalColumn: "Hosting_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    HostingHosting_id = table.Column<int>(nullable: false),
                    EquipmentEquipment_id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hosting_Equipment", x => new { x.EquipmentEquipment_id, x.HostingHosting_id });
                    table.ForeignKey(
                        name: "FK_Hosting_Equipment_Equipments_EquipmentEquipment_id",
                        column: x => x.EquipmentEquipment_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingBooking_id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.Comment_id);
                    table.ForeignKey(
                        name: "FK_Comments_Bookings_BookingBooking_id",
                        column: x => x.BookingBooking_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_HostingHosting_id",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_BookingBooking_id",
                table: "Comments",
                column: "BookingBooking_id",
                unique: true);
